  ...
  return (
    <div className='min-h-screen bg-cover bg-center flex items-center justify-center gap-8 sm:justify-evenly max-sm:flex-col backdrop-blur-2xl'>
      ...
      { currState ==='Sign up' && isDataSubmitted && ( 
        ...
        rows={4} className='p-2 border border-gray-500 rounded-md focus:outline-none focus:ring-2 focus:ring-indigo-500' placeholder='Provide the Short Bio'></textarea>
      )
      }
      ...
      <button type='submit' className='py-3 bg-gradient-to-r from-purple-400 to-violet-600 text-white rounded-md cursor-pointer'>
        ...
        <div className='flex flex-col gap-2'>
          {currState ==="Sign up" ? (
            ...
            className='text-sm text-gray-600'>Create Account <span className='font-medium text-violet-500 cursor-pointer'>Clicl Here</span></p>
          ) }
